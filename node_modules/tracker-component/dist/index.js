...
Tracker.Component = function (_React$Component) {
  ...
  (0, _createClass3.default)(_class, [{
    ...
    value: function autorun(fn) {
      ...
      this.__comps.push(Tracker.autorun(function (c) {
        _this2.__live = true;fn();_this2.__live = false;
      }));
    }
  }, {
    ...
    value: function render() {
      ...
      var comp = this.props.children.map(function (Child) {
        return _react2.default.createElement(Child, _this5.state);
      });
      return comp.length == 1 ? comp : _react2.default.createElement(
        'div',
        null,
        comp
      );
